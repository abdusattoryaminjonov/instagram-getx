...
import 'package:instaclon/controllers/profile_controller.dart';
import '../models/post_model.dart';
import '../views/item_of_profile_post.dart';
                      ...
                      Expanded(
                        child: GridView.builder(
                          ...
                          itemBuilder: (ctx, index) {
                            return itemOfProfilePost(profileController.items[index],profileController,context);
                          },
                        ),
                      ),
                    ],
