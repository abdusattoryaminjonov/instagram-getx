...
import 'package:instaclon/controllers/feed_controller.dart';
import '../views/item_of_feed_post.dart';
            ...
            children: [
              ListView.builder(
                ...
                itemBuilder: (ctx, index) {
                  return itemOfFeedPost(feedController.items[index],feedController,context);
                },
              ),
